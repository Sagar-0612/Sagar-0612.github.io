...
import MyPdf from  "../images/Sagar-Pawar-Resume.pdf"
const Navbar = () => {
  ...
  const handleDownload = () => {
    ...
    link.download = 'Sagar-Pawar-Resume.pdf';
    link.href = {MyPdf};
      ...
      <div className="flex items-center justify-between">
        ...
        >
          <ul className="flex items-center gap-1 py-2 text-lg">
            ...
            <a className="nav-link resume px-6 hover:text-cyan-600" href={MyPdf} target={"_blank"} rel="noreferrer">
